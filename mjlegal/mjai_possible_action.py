...
class MjaiPossibleActionGenerator:
    ...
    def possible_game_action_dahai_turn(self, game_state):
        possible_game_actions = (
            self.possibleAction.possible_actions_hora(game_state)
        ...
        mjai_possible = [
            action.to_mjai_json() for action in possible_game_actions if action.actor == game_state.player_id
        ]
