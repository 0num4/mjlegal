...
class MjaiPossibleActionGenerator :
    ...
    def possible_mjai_action(self, game_state, previous_mjai_action) :
        ...
        if action_type == "hello" :
            ...
            if (actor != game_state.player_id) \
                or (actor == game_state.player_id and action_type in ("dahai", "nukidora", "daiminkan", "ankan", "kakan")) :
                none_action = {"type" : "none"}
                possible_actions.append(none_action)
            ...
            mjai_possible = self.possible_game_action_without_reach(game_state)
    ...
    def possible_game_action_without_reach(self, game_state) :
