...
class HandTool:
    ...
    def can_hora(self, game_state, actor, win_tile, is_tsumo, is_rinshan):
        ...
        if self.agari.is_agari(tehais34):
            ...
            hand_config = self.make_hand_config(
                is_tsumo=is_tsumo,
                is_riichi=is_riichi,
            ...
            hand_value = self.hand.estimate_hand_value(
                tiles=full_tehai136, win_tile=win_tile136, melds=melds136, dora_indicators=dora_ind, config=hand_config
            )
