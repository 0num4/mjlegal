    ...
    def action(self, action) :
        ...
        if action_type == "start_game" :
            ...
            if action_type == "tsumo" :
                ...
                player_state.pon(pai, consumed, target)
                ...
                consumed_tiles = TilesUtil.str_to_tiles(consumed)
                self.game.previous_player.pop_ho()
                player_state.chi(pai, consumed, target)
                ...
                consumed_tiles = TilesUtil.str_to_tiles(consumed)
                self.game.previous_player.pop_ho()
                player_state.daiminkan(pai, consumed, target)
                ...
                pai = action["pai"]
                tile = Tile.from_str(pai)
                player_state.nukidora(pai)
                self.game.previous_action = Action(type = ActionType.NUKI, actor = action_actor, tile=tile)
